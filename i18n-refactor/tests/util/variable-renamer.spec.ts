import { renameVariable, renameMultipleVariables } from '../../src/util/variable-renamer';
...
describe('variable-renamer', () => {
  describe('renameVariable', () => {
    ...
    it('should not rename reserved words', () => {
      ...
      const result = renameVariable(sourceCode, 'value', 'const');
    ...
    it('should handle invalid identifiers', () => {
      ...
      const result = renameVariable(sourceCode, 'old-Name', 'newName');
    ...
    it('should not rename when old and new names are the same', () => {
      ...
      const result = renameVariable(sourceCode, 'oldName', 'oldName');
