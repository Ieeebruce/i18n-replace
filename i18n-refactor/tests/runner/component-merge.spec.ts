...
test('merge: dict alias from spreads common+app', () => {
  ...
  expect(
    out.htmlOut.includes("{{ 'common.common.title' | i18n }}") ||
    out.htmlOut.includes("{{ 'app.common.title' | i18n }}")
  ).toBe(true)
  expect(
    out.htmlOut.includes("{{ 'common.app.desc' | i18n }}") ||
    out.htmlOut.includes("{{ 'app.app.desc' | i18n }}")
  ).toBe(true)
})
