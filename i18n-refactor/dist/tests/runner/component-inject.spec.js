...
describe('Component Service Injection', () => {
    ...
    beforeAll(() => {
        ...
        config_1.config.serviceVariableName = 'i18n';
    });
    afterAll(() => {
        config_1.config.serviceVariableName = originalVarName;
    });
    ...
    `;
        ...
        expect(matches === null || matches === void 0 ? void 0 : matches.length).toBe(1);
    });
    it('should use configured service variable name', () => {
        config_1.config.serviceVariableName = 'customService';
        const tsCode = `
      import { Component } from '@angular/core';
      @Component({})
      export class C {
    ...
    `;
        ...
        config_1.config.serviceVariableName = 'i18n'; // reset
    });
});
